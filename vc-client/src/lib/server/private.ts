...
export const wsServerUrl =  `${environmentType === 'production' ? serverBase  : 'localhost'}:${serverPort}`;
export const apiServerUrl = `${environmentType === 'production' ? serverBase  : 'localhost'}:${serverPort}`;